...
public class Programa {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Final NOTES/MEDIA to APPROVED: %.2f%n", student.media_approve);
		System.out.printf("Final MEDIA: %.2f%n", student.finalMedia());
		System.out.println("========================================");
		
		if(student.finalNotes() < 30.0){
			System.out.printf("Studend REPRO - [FAILD] - Missing: ");
